...
export class ConfirmAllAttendeeCall extends ethereum.Call {
  get inputs(): ConfirmAllAttendeeCall__Inputs {
    return new ConfirmAllAttendeeCall__Inputs(this);
  }

  get outputs(): ConfirmAllAttendeeCall__Outputs {
    return new ConfirmAllAttendeeCall__Outputs(this);
  }
}

export class ConfirmAllAttendeeCall__Inputs {
  _call: ConfirmAllAttendeeCall;

  constructor(call: ConfirmAllAttendeeCall) {
    this._call = call;
  }
...
export class ConfirmAllAttendeeCall__Outputs {
  _call: ConfirmAllAttendeeCall;
...
export class CreatNewEventCall extends ethereum.Call {
  get inputs(): CreatNewEventCall__Inputs {
    return new CreatNewEventCall__Inputs(this);
  }

  get outputs(): CreatNewEventCall__Outputs {
    return new CreatNewEventCall__Outputs(this);
  }
}

export class CreatNewEventCall__Inputs {
  _call: CreatNewEventCall;

  constructor(call: CreatNewEventCall) {
    this._call = call;
  }
...
export class CreatNewEventCall__Outputs {
  _call: CreatNewEventCall;
